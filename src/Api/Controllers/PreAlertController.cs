...
[ApiController]
public class PreAlertController : ControllerBase
{
    private readonly IPreAlertService _service;

    public PreAlertController(IPreAlertService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(PreAlertAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<PreAlertAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(PreAlertAddEditDto dto)
    {
