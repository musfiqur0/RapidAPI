...
{
    private readonly ISourceTypeService _service;

    public SourceTypeController(ISourceTypeService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(SourceTypeAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<SourceTypeAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(SourceTypeAddEditDto dto)
    {
