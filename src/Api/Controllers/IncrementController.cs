...
public class IncrementController : ControllerBase
{
    ...
    public IncrementController(IIncrementService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(IncrementAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<IncrementAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(IncrementAddEditDto dto)
    {
