...
public class BonusController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(BonusAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<BonusAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(BonusAddEditDto dto)
    {
