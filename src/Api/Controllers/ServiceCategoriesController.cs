...
public class ServiceCategoriesController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(ServiceCategoriesAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<ServiceCategoriesAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(ServiceCategoriesAddEditDto dto)
    {
