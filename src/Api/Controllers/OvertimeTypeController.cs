...
{
    private readonly IOvertimeTypeService _service;

    public OvertimeTypeController(IOvertimeTypeService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(OvertimeTypeAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<OvertimeTypeAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(OvertimeTypeAddEditDto dto)
    {
