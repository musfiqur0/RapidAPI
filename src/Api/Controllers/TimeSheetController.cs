...
public class TimeSheetController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(TimeSheetAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<TimeSheetAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(TimeSheetAddEditDto dto)
    {
