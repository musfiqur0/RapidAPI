...
public class ServiceController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(ServiceAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<ServiceAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(ServiceAddEditDto dto)
    {
