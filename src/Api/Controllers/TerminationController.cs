...
{
    private readonly ITerminationService _service;

    public TerminationController(ITerminationService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(TerminationAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<TerminationAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(TerminationAddEditDto dto)
    {
