...
public class LeaveApplicationController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(LeaveApplicationAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<LeaveApplicationAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(LeaveApplicationAddEditDto dto)
    {
