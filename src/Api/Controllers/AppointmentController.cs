...
public class AppointmentController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(AppointmentAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<AppointmentAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(AppointmentAddEditDto dto)
    {
