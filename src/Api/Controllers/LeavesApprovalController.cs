...
[ApiController]
public class LeavesApprovalController : ControllerBase
{
    private readonly ILeavesApprovalService _service;

    public LeavesApprovalController(ILeavesApprovalService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(LeavesApprovalAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<LeavesApprovalAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(LeavesApprovalAddEditDto dto)
    {
