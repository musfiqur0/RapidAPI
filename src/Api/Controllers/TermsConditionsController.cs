...
public class TermsConditionsController : ControllerBase
{
    ...
    public TermsConditionsController(ITermsConditionsService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(TermsConditionsAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<TermsConditionsAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(TermsConditionsAddEditDto dto)
    {
