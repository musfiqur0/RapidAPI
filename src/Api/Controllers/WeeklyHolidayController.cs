...
[ApiController]
public class WeeklyHolidayController : ControllerBase
{
    private readonly IWeeklyHolidayService _service;

    public WeeklyHolidayController(IWeeklyHolidayService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(WeeklyHolidayAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<WeeklyHolidayAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(WeeklyHolidayAddEditDto dto)
    {
