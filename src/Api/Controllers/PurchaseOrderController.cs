...
public class PurchaseOrderController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(PurchaseOrderAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<PurchaseOrderAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(PurchaseOrderAddEditDto dto)
    {
