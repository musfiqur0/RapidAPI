...
public class AllowanceTypeController : ControllerBase
{
    ...
    public AllowanceTypeController(IAllowanceTypeService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(AllowanceTypeAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<AllowanceTypeAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(AllowanceTypeAddEditDto dto)
    {
