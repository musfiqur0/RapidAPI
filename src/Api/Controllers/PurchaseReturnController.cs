...
public class PurchaseReturnController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(PurchaseReturnAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<PurchaseReturnAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(PurchaseReturnAddEditDto dto)
    {
