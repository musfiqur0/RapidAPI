...
public class AllowanceController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(AllowanceAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<AllowanceAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(AllowanceAddEditDto dto)
    {
