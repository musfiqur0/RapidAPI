...
public class PurchaseInvoiceController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(PurchaseInvoiceAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<PurchaseInvoiceAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(PurchaseInvoiceAddEditDto dto)
    {
