...
[ApiController]
public class BenefitPenaltyController : ControllerBase
{
    private readonly IBenefitPenaltyService _service;

    public BenefitPenaltyController(IBenefitPenaltyService service)
    {
        _service = service;
    }
    ...
    [HttpPost]
    public async Task<IActionResult> CreateSingle(BenefitPenaltyAddEditDto dto)
    {
    ...
    [HttpPost]
    public async Task<IActionResult> CreateBulk(List<BenefitPenaltyAddEditDto> dto)
    {
    ...
    [HttpPut]
    public async Task<IActionResult> Update(BenefitPenaltyAddEditDto dto)
    {
