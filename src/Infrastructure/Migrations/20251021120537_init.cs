        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActionTypeId1 = table.Column<short>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeAudits_StatusTypes_StatusTypeId",
                        column: x => x.StatusTypeId,
                        principalTable: "StatusTypes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeLocalizations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EmployeeLocalizations_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeAudits_StatusTypeId",
                table: "EmployeeAudits",
                column: "StatusTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeLocalizations_EmployeeId",
                table: "EmployeeLocalizations",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeLocalizations_LanguageId",
                table: "EmployeeLocalizations",
                column: "LanguageId");
